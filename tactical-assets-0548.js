...
function installRenderHook(){
  if(typeof renderEntity!=='function'||renderEntity.__tacticalAssets0548)return;
  ...
  hooked.__tacticalAssets0548=true;
  renderEntity=hooked;
}

function installTrapHook(){
  if(typeof isoTrapMarkup!=='function'||isoTrapMarkup.__tacticalAssets0548)return;
